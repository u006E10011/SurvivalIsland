...
namespace Gaskellgames
{
    ...
    public class DisableIfAttribute : PropertyAttribute
    {
        ...
        public DisableIfAttribute(string field)
        {
        ...
        public DisableIfAttribute(string field, object comparison)
        {
        ...
        public DisableIfAttribute(string[] fields, object[] comparisons, LogicGate logicGate = LogicGate.AND)
        {
