...
namespace Gaskellgames
{
    ...
    public class EnableIfAttribute : PropertyAttribute
    {
        ...
        public EnableIfAttribute(string field)
        {
        ...
        public EnableIfAttribute(string field, object comparison)
        {
        ...
        public EnableIfAttribute(string[] fields, object[] comparisons, LogicGate logicGate = LogicGate.AND)
        {
